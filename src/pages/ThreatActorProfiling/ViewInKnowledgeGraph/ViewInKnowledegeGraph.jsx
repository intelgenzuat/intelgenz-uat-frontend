            ...
            <div className="graph-header">
                ...
                <div className="d-flex flex-column gap-2 w-100">
                    ...
                    <div className="breadcrumb-nav text-muted">
                        ...
                        <span onClick={() => navigate("/")} className="breadcrumb-clickable">Home</span>
                        <span className="mx-2 text-black-50">/</span>
                        <span onClick={() => navigate(parentPath)} className="breadcrumb-clickable">{parentName}</span>
                        <span className="mx-2 text-black-50">/</span>
                        <span className="text-dark fw-semibold">View in Knowledge Graph</span>
                    </div>
