            ...
            <div className="d-flex flex-column w-100 gap-4">
              ...
              <div className="bg-white rounded-4 p-4 w-100">
                    <h5 className="mb-4 text-dark font-weight-bold d-flex align-items-center gap-2" style={{ fontSize: '15px', letterSpacing: '-0.3px' }}>
                      <div className="d-flex align-items-center justify-content-center rounded-circle" style={{ width: '24px', height: '24px', backgroundColor: '#fff1f2' }}>
                        <i className="bi bi-activity" style={{ fontSize: '12px', color: '#f43f5e', strokeWidth: '2' }}></i>
                      </div>
                      Activity Timeline
                    </h5>
                    ...
                    <div className="position-relative w-100 bg-white border rounded-4 p-4" style={{ borderColor: '#e2e8f0' }}>
                      <svg viewBox="0 0 600 250" className="w-100 h-auto" style={{ maxHeight: '250px' }}>
                        <defs>
                          <linearGradient id="chart-gradient-actor" x1="0" y1="0" x2="0" y2="1">
                            <stop offset="0%" stopColor="#f43f5e" stopOpacity="0.2" />
                            <stop offset="100%" stopColor="#f43f5e" stopOpacity="0" />
                          </linearGradient>
                          <linearGradient id="line-gradient-actor" x1="0" y1="0" x2="1" y2="0">
                        ...
                        <path
                          ...
                          fill="none"
                          stroke="url(#line-gradient-actor)"
                          strokeWidth="3"
                          strokeLinecap="round"
                        ...
                        <g className="chart-points">
                          <circle cx="141.6" cy="80" r="5" fill="#f43f5e" stroke="#ffe4e6" strokeWidth="3" />
                          <circle cx="223.3" cy="140" r="5" fill="#f43f5e" stroke="#ffe4e6" strokeWidth="3" />
                          <circle cx="305" cy="44" r="5" fill="#f43f5e" stroke="#ffe4e6" strokeWidth="3" />
                          <circle cx="386.6" cy="74" r="5" fill="#f43f5e" stroke="#ffe4e6" strokeWidth="3" />
                        </g>
                      </svg>
                  </div>
              </div>
              ...
              <div className="bg-white rounded-4 p-4 w-100">
                <h5 className="mb-4 text-dark font-weight-bold d-flex align-items-center gap-2" style={{ fontSize: '15px', letterSpacing: '-0.3px' }}>
                  <div className="d-flex align-items-center justify-content-center rounded-circle shadow-sm" style={{ width: '24px', height: '24px', backgroundColor: '#fff', border: '1px solid #fbcfe8' }}>
                    <i className="bi bi-gem" style={{ fontSize: '12px', color: '#f43f5e' }}></i>
                  </div>
                  Diamond Model
                </h5>

                <div className="position-relative w-100 d-flex justify-content-center align-items-center" style={{ minHeight: '400px' }}>
                  <div className="position-relative w-100" style={{ maxWidth: '900px' }}>
                    <svg viewBox="0 0 900 400" className="w-100 h-auto">
                      {/* Diamond lines */}
                      <polygon
                      ...
                      />
                      {/* Cross lines */}
                      <line x1="250" y1="80" x2="250" y2="360" stroke="#fbcfe8" strokeWidth="1.5" strokeDasharray="4 4" />
                      <line x1="100" y1="220" x2="400" y2="220" stroke="#fbcfe8" strokeWidth="1.5" strokeDasharray="4 4" />

                      {/* Connection line to popover */}
                      <line x1="250" y1="80" x2="450" y2="60" stroke="#fbcfe8" strokeWidth="1.5" strokeDasharray="4 4" />
                      
                      {/* Connection Dot */}
                      <circle cx="450" cy="60" r="6" fill="#f43f5e" stroke="#ffe4e6" strokeWidth="4" />

                      {/* Vertices */}
                      {/* Adversary */}
                      <circle cx="250" cy="80" r="6" fill="#f43f5e" stroke="#ffe4e6" strokeWidth="4" />
                      <text x="250" y="60" fill="#1e293b" fontSize="12" fontWeight="500" textAnchor="middle">Adversary</text>

                      {/* Victim */}
                      <circle cx="250" cy="360" r="6" fill="#f43f5e" stroke="#ffe4e6" strokeWidth="4" />
                      <text x="250" y="380" fill="#1e293b" fontSize="12" fontWeight="500" textAnchor="middle">Victim</text>

                      {/* Capabilities */}
                      <circle cx="100" cy="220" r="6" fill="#f43f5e" stroke="#ffe4e6" strokeWidth="4" />
                      <text x="80" y="224" fill="#1e293b" fontSize="12" fontWeight="500" textAnchor="end">Capabilities</text>

                      {/* Infrastructure */}
                      <circle cx="400" cy="220" r="6" fill="#f43f5e" stroke="#ffe4e6" strokeWidth="4" />
                      <text x="420" y="224" fill="#1e293b" fontSize="12" fontWeight="500" textAnchor="start">Infrastructure</text>
                    </svg>
                    ...
                    >
                      <div className="d-inline-block px-3 py-1 rounded-pill mb-3" style={{ backgroundColor: '#fff1f2', color: '#1e293b', fontSize: '12px', fontWeight: '600' }}>
                        Victims & Infrastructure
                      </div>

                      <div className="mb-3">
                        <div className="text-dark fw-bold mb-2" style={{ fontSize: '11px' }}>Victims</div>
                        <div className="d-flex gap-3">
                          <div style={{ flex: 1 }}>
                            <div className="d-flex align-items-start gap-2">
                              <div className="mt-1 flex-shrink-0 rounded-circle" style={{ width: '8px', height: '8px', border: '1.5px solid #fbcfe8' }}></div>
                              <div>
                                <span className="fw-semibold text-dark d-block" style={{ fontSize: '11px' }}>Enterprises:</span>
                                <span className="text-secondary" style={{ fontSize: '11px', lineHeight: '1.4' }}>Corporate networks, FinTech databases, and government departments.</span>
                              </div>
                            </div>
                          </div>
                          <div style={{ flex: 1 }}>
                            <div className="d-flex align-items-start gap-2">
                              <div className="mt-1 flex-shrink-0 rounded-circle" style={{ width: '8px', height: '8px', border: '1.5px solid #fbcfe8' }}></div>
                              <div>
                                <span className="fw-semibold text-dark d-block" style={{ fontSize: '11px' }}>Mobile Users:</span>
                                <span className="text-secondary" style={{ fontSize: '11px', lineHeight: '1.4' }}>Android app environments susceptible to credential theft.</span>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div>
                        <div className="text-dark fw-bold mb-2" style={{ fontSize: '11px' }}>Infrastructure</div>
                        <div className="d-flex gap-3">
                          <div style={{ flex: 1 }}>
                            <div className="d-flex align-items-start gap-2">
                              <div className="mt-1 flex-shrink-0 rounded-circle" style={{ width: '8px', height: '8px', border: '1.5px solid #fbcfe8' }}></div>
                              <div>
                                <span className="fw-semibold text-dark d-block" style={{ fontSize: '11px' }}>C2 Centers:</span>
                                <span className="text-secondary" style={{ fontSize: '11px', lineHeight: '1.4' }}>Command centers routing malware traffic (194.26.29.81).</span>
                              </div>
                            </div>
                          </div>
                          <div style={{ flex: 1 }}>
                            <div className="d-flex align-items-start gap-2">
                              <div className="mt-1 flex-shrink-0 rounded-circle" style={{ width: '8px', height: '8px', border: '1.5px solid #fbcfe8' }}></div>
                              <div>
                                <span className="fw-semibold text-dark d-block" style={{ fontSize: '11px' }}>Hosting:</span>
                                <span className="text-secondary" style={{ fontSize: '11px', lineHeight: '1.4' }}>Bulletproof server nodes hosting Flutter payload servers.</span>
                              </div>
                            </div>
                          </div>
                        </div>
              ...
              <div className="bg-white rounded-4 p-4 w-100">
                <h5 className="mb-4 text-dark font-weight-bold d-flex align-items-center gap-2" style={{ fontSize: '15px', letterSpacing: '-0.3px' }}>
                  <div className="d-flex align-items-center justify-content-center rounded-circle shadow-sm" style={{ width: '24px', height: '24px', backgroundColor: '#fff', border: '1px solid #fbcfe8' }}>
                    <i className="bi bi-list-task" style={{ fontSize: '12px', color: '#f43f5e' }}></i>
                  </div>
                  TTP View
                </h5>
                <div className="ttp-table-container w-100 border rounded-3 overflow-hidden" style={{ borderColor: '#e2e8f0' }}>
                  <div className="table-responsive custom-scrollbar" style={{ overflowX: 'auto' }}>
                    <table className="table table-bordered mb-0 text-center align-middle" style={{ minWidth: '900px', borderColor: '#f1f5f9' }}>
                      <thead style={{ backgroundColor: '#f8fafc' }}>
                        <tr>
                          {['Reconnaissance', 'Resource Development', 'Initial Access', 'Execution', 'Persistence', 'Execution', 'Execution'].map((header, i) => (
                            <th key={i} className="py-3 px-2 fw-semibold border-bottom" style={{ color: '#334155', fontSize: '12px', borderColor: '#e2e8f0', whiteSpace: 'nowrap', backgroundColor: '#f8fafc' }}>
                              <i className="bi bi-filter me-1" style={{ color: '#8b5cf6', fontSize: '14px' }}></i> {header}
                            </th>
                          ))}
                        </tr>
                      </thead>
                        ...
                        {[...Array(6)].map((_, rowIndex) => (
                          <tr key={rowIndex}>
                            {[...Array(7)].map((_, colIndex) => (
                              <td key={colIndex} className="py-3 px-2" style={{ borderColor: '#f1f5f9' }}>
                                <div className="d-flex flex-column align-items-center justify-content-center">
                                  <span className="fw-medium text-dark" style={{ fontSize: '11px' }}>T1569</span>
                                  <span className="text-secondary mt-1" style={{ fontSize: '10px' }}>Network Sniffing...</span>
                                </div>
                              </td>
                            ))}
                          </tr>
