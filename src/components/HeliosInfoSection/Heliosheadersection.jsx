...
import './heliosheader.scss';

const Heliosheadersection = () => {
    const heliosMenu = {
        items: [
            {
                key: '1',
                label: (
                    <div className="helios-dropdown-content">
                        <div className="helios-dropdown-header">
                            <div className="helios-badge-title">
                                <span className="helios-status-indicator"></span>
                                <strong>HELIOS AI Intel</strong>
                            </div>
                            <span className="helios-target-badge">Active Target</span>
                        </div>
                        <div className="helios-dropdown-body">
                            <div className="helios-info-row">
                                <PiBuildingOfficeDuotone className="row-icon text-primary" />
                                <div className="row-text">
                                    <span className="label">Sector:</span>
                                    <span className="value">FinTech &bull; B2B AI SaaS</span>
                                </div>
                            </div>
                            <div className="helios-info-row">
                                <i className="bi bi-globe row-icon text-info"></i>
                                <div className="row-text">
                                    <span className="label">Location:</span>
                                    <span className="value">US-based</span>
                                </div>
                            </div>
                            <div className="helios-info-row">
                                <PiTreeViewDuotone className="row-icon text-success" />
                                <div className="row-text">
                                    <span className="label">Reviewed by:</span>
                                    <span className="value">Security Admin</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    return (
        <Dropdown menu={heliosMenu} trigger={['hover']} placement="bottomRight" arrow>
            <div className="helios-header-btn" title="Helios AI Organization Profile">
                <div className="helios-icon-box">
                ...
                <span className="helios-title">HELIOS AI</span>
                <svg
                    className="helios-chevron"
                    width="14"
                    height="14"
                    viewBox="0 0 24 24"
                    fill="none"
...
export default Heliosheadersection;
